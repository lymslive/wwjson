...
## TODO:2026-01-11/3 v1.1.0 封版

- 检查 CMake 构建脚本更新版本号
- 将根目录的 task_todo.md 与 task_log.md 移到 changelog/v1.1 子目录
- 根目录重建新的 task_todo.md 与 task_log.md , 保留 v1.1 的接要与链接
- changelog/v1.1/task_log.md 最后一个任务记录本次发布任务，包括一份简要的
  release note.
- 提交 dev ，合并到 main ，打标签 v1.1.0，推送 github

数字序列化算法的进一步优化研究计划在下个版本。

## DONE: 20260111-184936