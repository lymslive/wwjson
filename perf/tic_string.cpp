/**
 * @file tic_string.cpp
 * @brief Absolute time performance tests for string serialization
 *
 * @details
 * This file contains DEF_TAST test cases that use absolute timing (TIME_TIC/TIME_TOC)
 * for measuring string serialization performance. These tests were separated from p_string.cpp
 * to keep relative performance tests (using RelativeTimer) separate from absolute timing tests.
 *
 * These tests are compiled into the ticwwjson target and compare wwjson string
 * serialization performance against yyjson for various string operations.
 */
...
DEF_TAST(tic_string_array_wwjson, "wwjson 字符串数组构建性能测试")
{
    test::CArgv argv;
...
DEF_TAST(tic_string_array_yyjson, "yyjson 字符串数组构建性能测试")
{
    test::CArgv argv;
    std::string json_data;
...
DEF_TAST(tic_string_object_wwjson, "wwjson 字符串对象构建性能测试")
{
    test::CArgv argv;
    std::string json_data;
...
DEF_TAST(tic_string_object_yyjson, "yyjson 字符串对象构建性能测试")
{
    test::CArgv argv;
    std::string json_data;
...
DEF_TAST(tic_string_escape_wwjson, "wwjson 转义字符串对象构建性能测试")
{
    test::CArgv argv;
    std::string json_data;
...
DEF_TAST(tic_string_escape_yyjson, "yyjson 转义字符串对象构建性能测试")
{
    test::CArgv argv;
    std::string json_data;
...
DEF_TOOL(tic_string_compare, "比较 wwjson 和 yyjson 字符串函数输出")
{
    test::CArgv argv;
    int test_count = 5;
